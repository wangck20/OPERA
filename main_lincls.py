...
def save_checkpoint(state, is_best, filename='/mnt/cfs/algorithm/chengkun.wang/wck/experiments/mocov3_r/checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, '/mnt/cfs/algorithm/chengkun.wang/wck/experiments/mocov3_r/model_best.pth.tar')
